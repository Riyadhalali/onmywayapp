...
class ToggleButtonMaleFemale extends StatefulWidget {
  //Function function;
  String imageAssetFirst;
  String imageAssetSecond;
  ToggleButtonMaleFemale(this.imageAssetFirst, this.imageAssetSecond);

  // ToggleButton({this.function});
//TODO: using provider when user select choice to update the selection
  @override
  State<ToggleButtonMaleFemale> createState() => _ToggleButtonMaleFemaleState();
}

class _ToggleButtonMaleFemaleState extends State<ToggleButtonMaleFemale> {
    ...
    return ToggleButtons(
      ...
      onPressed: (int index) {
        setState(() {
          ...
          globalProviders.changeIndexToggleButton(index);
        });
      },
      children: <Widget>[
        Padding(
