...
class MapPickerTo extends StatefulWidget {
  static const id = 'map_picker_to';
  double latitudePassed, longitudePassed;
  bool placeFromOrTo;
  String appointmentId;

  MapPickerTo({this.appointmentId, this.latitudePassed, this.longitudePassed, this.placeFromOrTo});
  @override
  _MapPickerToState createState() => _MapPickerToState();
}

class _MapPickerToState extends State<MapPickerTo> {
...
//                           }
                          ...
                          mapProvider.addServicePageToPlace(placeName);
